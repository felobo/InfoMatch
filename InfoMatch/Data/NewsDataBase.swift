...
struct NewsDataBase {
    ...
    init() {
        ...
        dataBase.append(News(type: NewsType.Opinion, img: NewsImages.bazzoOpinion.rawValue, context: ["Geraldo Thumberg é um jovem ativista do meio ambiente que tem viralizado por produzir vídeos denunciando negligências das nações em relação ao meio ambiente", "J.R Gazzo é um jornalista que escreve colunas semanais."]))
    }
}
